    ...
    return (
        <div className='setupInputs'
            ...
            <div className='isetup'>
                <p>Gap</p>
                <div>        
                    <input className='setupInputSlider' type='range' defaultValue={50} onChange={(e)=>modifyOptions(e.target.value*2,'gapWidth')} />    
                </div>
                ...
                <div className='isetup'>
                    <p>Birds</p>
                    <div>
                        <input className='setupInputSlider' type='range' defaultValue={5} onChange={(e)=>modifyOptions(e.target.value,'population')} /> 
                    </div>
